...
import DiagnosisSchemas from "schemas/DiagnosisSchemas";
import TextInput from "components/core/TextInput";
import { ArrowForward, ArrowRightAlt, Done } from "@mui/icons-material";
...
const DiagnosisTab = () => {
	...
	const validationSchema = DiagnosisSchemas?.reduce(
				...
				{(formik) => (
					<Form>
						<div className="grid grid-cols-1 gap-1 w-full justify-center items-center justify-items-center">
							{DiagnosisSchemas?.map((inputItem) => (
								<>
									{
										<div
											className={
