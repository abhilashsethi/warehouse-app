...
import AddExpenseSchemas from "schemas/AddExpenseSchemas";
...
const AddExpenseDrawer = ({ open, onClose, mutate }: Props) => {
	...
	const initialValues = AddExpenseSchemas.reduce(
	...
	const validationSchema = AddExpenseSchemas.reduce(
		(accumulator, currentValue) => {
			...
			<Drawer anchor="right" open={open} onClose={() => onClose && onClose()}>
				...
				>
					...
					>
						{(formik) => (
							<Form>
								{AddExpenseSchemas?.map((inputItem, index) => (
									<div key={index}>
