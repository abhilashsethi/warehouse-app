		...
		<AdminLayout title="Admin Dashboard">
			<div className="grid grid-cols-12 content-between gap-6  m-5 !mb-6 ">
				<InfoCards
					...
					icon={
						<FaStethoscope className="h-7 w-7 rounded-md group-hover:text-white  text-[#913d83]" />
					}
				...
				<InfoCards
					...
					icon={
						...
						<LocalHotel className=" text-[#913d83] h-7 w-7 rounded-md group-hover:text-white " />
					}
				...
				<InfoCards
					...
					icon={
						// <Build className="text-white h-7 w-7 rounded-md group-hover:text-white " />
						<Apartment className="text-[#913d83] h-7 w-7 rounded-md group-hover:text-white " />
					}
				...
				<InfoCards
					...
					icon={
						// <Build className="text-white h-7 w-7 rounded-md group-hover:text-white " />
						<PermContactCalendar className="text-[#913d83] h-7 w-7 rounded-md group-hover:text-white " />
					}
				...
				<InfoCards
					...
					icon={
						// <Build className="text-white h-7 w-7 rounded-md group-hover:text-white " />
						<Article className="h-7 w-7 rounded-md group-hover:text-white  text-[#913d83]" />
					}
				...
				<InfoCards
					...
					icon={
						// <Build className="text-white h-7 w-7 rounded-md group-hover:text-white " />
						<AirlineSeatFlat className="h-7 w-7 rounded-md group-hover:text-white  text-[#913d83]" />
					}
				...
				<InfoCards
					...
					icon={
						// <Build className="text-white h-7 w-7 rounded-md group-hover:text-white " />
						<Science className="h-7 w-7 rounded-md group-hover:text-white  text-[#913d83]" />
					}
				...
				<InfoCards
					...
					icon={
						// <Build className="text-white h-7 w-7 rounded-md group-hover:text-white " />
						<CurrencyRupee className="h-7 w-7 rounded-md group-hover:text-white  text-[#913d83]" />
					}
