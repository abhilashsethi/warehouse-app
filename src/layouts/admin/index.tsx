...
import { ICONS } from "assets";
import { useLoginData, useMenuItems, useWarehouseData } from "hooks";
...
const AdminLayout = ({ children, title = "YardHealth" }: Props) => {
							...
							<div className="flex items-center gap-6">
								...
								>
									<Link href="/panel/admin/notification">
										<div className="cursor-pointer rounded-lg bg-theme p-2 shadow-md">
